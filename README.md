...
│   ├── lenguajes.md              → Python, C, C++, MATLAB, Simulink — la lógica importa más que la sintaxis
...
│   ├── robotica-y-vision.md      → Path planning, computer vision, machine learning aplicado
